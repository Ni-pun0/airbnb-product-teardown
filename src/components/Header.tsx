  ...
  return <header className={cn("py-6 sticky top-0 z-50 bg-white bg-opacity-90 backdrop-blur-md border-b", className)} {...props}>
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <img alt="Airbnb Logo" className="h-10 w-auto object-contain cursor-pointer" onClick={refreshPage} src="/lovable-uploads/e936742a-5b0a-492e-b4ca-6ec2f930b51b.png" />
