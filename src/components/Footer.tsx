...
const Footer = () => {
  return <footer className="bg-airbnb-light_gray py-10 mt-16">
      <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
        <img src="/lovable-uploads/e87f1777-4275-44f0-9a9c-42e72c3b41aa.png" alt="Airbnb Logo" className="max-h-10 overflow-auto mx-auto mb-4 object-fill" />
